...
public class Magpie5 {
  ...
  /**
   * Take a statement with "I want to <something>." and transform it into "What would it mean to
   * <something>?"
   * 
  ...
  /**
   * Take a statement with "you <something> me" and transform it into "What makes you think that I
   * <something> you?"
   * 
   ...
   * Search for one word in phrase. The search is not case sensitive. This method will check that
   * the given goal is not a substring of a longer string (so, for example, "I know" does not
   * contain "no"). The search begins at the beginning of the string.
   * 
   * @param statement the string to search
   * @param goal the string to search for
   * @return the index of the first occurrence of goal in statement or -1 if it's not found
  ...
  private String[] randomResponses = {"Interesting, tell me more", "Hmmm.",
      "Do you really think so?", "Cool.", "Good job.", "Wow.", "Uhh.", "You don't say."};
