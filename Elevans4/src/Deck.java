...
/**
 * The Deck class represents a shuffled deck of cards. It provides several operations including
...
public class Deck {
  ...
  /**
   * size is the number of not-yet-dealt cards. Cards are dealt from the top (highest index) down.
