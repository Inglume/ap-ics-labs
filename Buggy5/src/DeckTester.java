...
public class DeckTester {
  ...
  /**
   * The main method in this class checks the Deck operations for consistency using assert
   * statements.
   * 
  ...
  private static void test2CardDeck() {
    ...
    if (aceIsFirst) {
      assert c.matches(new Card("2", "hearts", 2)) : "2nd card dealt is " + c
          + ". It is not one of the two correct cards.";
    } else {
      assert c.matches(new Card("ace", "hearts", 1)) : "2nd card dealt is " + c
          + ". It is not one of the two correct cards.";
    }
    testEmpty(d);
    ...
    aceIsFirst = c.matches(new Card("ace", "hearts", 1));
    twoIsFirst = c.matches(new Card("2", "hearts", 2));
    assert (aceIsFirst || twoIsFirst) : "1st card dealt after shuffle is " + c
        + ".  It is not the one of the two correct cards.";
    ...
    if (aceIsFirst) {
      assert c.matches(new Card("2", "hearts", 2)) : "2nd card dealt after shuffle is " + c
          + ". It is not the one of the two correct cards.";
    } else {
      assert c.matches(new Card("ace", "hearts", 1)) : "2nd card dealt after shuffle is " + c
          + ". It is not the one of the two correct cards.";
    }
    testEmpty(d);
  }
  ...
  private static void testOneCard(Deck d, Card intended) {
    ...
    assert c.matches(intended) : "1st card dealt for a 1-card deck is " + c + ". It should be "
        + intended + ".";
  }
