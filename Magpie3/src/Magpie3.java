...
public class Magpie3 {
  ...
  public String getResponse(String statement) {
    ...
    } else if (findKeyword(statement, "Ms. Krasteva", 0) >= 0) {
      response = "Ms. Krasteva is a cool person.";
    } else if (findKeyword(statement, "giraffe", 0) >= 0) {
      response = "Tell me more about giraffes.";
    } else if (findKeyword(statement, "peregrine falcon", 0) >= 0) {
      response = "Tell me more about peregrine falcons.";
    } else if (findKeyword(statement, "existential crisis", 0) >= 0) {
      response = "Tell me more about existential crises.";
    } else {
  ...
  private String getRandomResponse() {
    ...
    if (whichResponse == 0) {
      ...
      response = "That is so very really interesting.";
    }
