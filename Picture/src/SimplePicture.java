...
public class SimplePicture implements DigitalPicture {
   ...
   * 100 that is all white. A no-argument constructor must be given in order for a class to be able
   * to be subclassed. By default all subclasses will implicitly call this in their parent's
   * no-argument constructor unless a different call to super() is explicitly made as the first line
   ...
   * image of that size. This constructor doesn't show the picture. The pixels will all be white.
   * 
  ...
  /**
   * Method to create a new picture of the passed width. The aspect ratio of the width and height
   * will stay the same.
   * 
   * @param width the desired width
   * @return the resulting picture
  ...
  public String toString() {
    String output =
        "Simple Picture, filename " + fileName + " height " + getHeight() + " width " + getWidth();
    return output;
  }
